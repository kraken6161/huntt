...
Tasarım ilkeleri:
	...
	•	Iska oranı %20–30 civarında kalmalı. Sıfıra inerse kıtlık hissedilmez.
	•	Incremental eğri run içinde olur: skor küçük başlar, tur sonuna doğru patlar, run bitince sıfırlanır.
	•	Kalıcı güç yok. İleride meta eklenirse dikey güç değil, yatay açılım (havuza yeni yükseltme girer).
Kapsam: Prototip. Grafik, ses, menü, kayıt yok. Tek dosya, kütüphanesiz. Tüm sayılar CONFIG'de ve debug slider'ında.
Açık soru: Mermi ekonomisi ve karar yoğunluğu tatmin edici mi?
